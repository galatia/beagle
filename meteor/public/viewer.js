...
function webViewerInitialized() {
  ...
  document.getElementById('download').addEventListener('click',
    ...
    // ADDED STUFF
    chrome.runtime.sendMessage("bhjfbddokfglmbbbbbhdedminmankmnc", {url: file}, function(response) {
      console.log(response.blobURL);
      PDFViewerApplication.open(response.blobURL, 0)
    });

    //END ADDED STUFF

  if (false && file && file.lastIndexOf('file:', 0) === 0) {
